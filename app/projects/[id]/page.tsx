...
const projects = [
  ...
  // },
    ...
    name: "Deit Planner",
    description:
      "Diet Planner is a web application designed to help users create and manage personalized diet plans. It offers features like meal tracking, nutritional analysis, and recipe suggestions to promote healthy eating habits.",
    longDescription:
      "Diet Planner is a web application designed to help users create and manage personalized diet plans. It offers features like meal tracking, nutritional analysis, and recipe suggestions to promote healthy eating habits. Users can input their dietary preferences, track their daily food intake, and receive tailored meal recommendations based on their nutritional goals. The platform also provides insights into calorie consumption, macronutrient breakdowns, and progress tracking to support users in achieving their health and fitness objectives.",
    categories: ["Next.js", "Tailwind CSS", "typeScript"],
    websiteUrl: "https://diet-plan-website-nine.vercel.app/",
    images: [
      "/vv1.jpg",
      "/vv2.jpg",
      "/vv3.jpg",
  ...
  },
  {
    ...
    websiteUrl: "https://coffee-house1.vercel.app/",
    images: [
      "/coffee.png",
      "/coffee6.png",
      "/coffee9.png",
  ...
  // },
  {
    ...
    categories: ["Landing page", "Illustration design"],
    websiteUrl: "https://aqeel-devops-medical-chatbot-assistant-main-pl8aus.streamlit.app/",
    images: [
      "/project4(1image).png",
      "/project1(3image).png",
      "/project1.png"
  ...
  //   categories: ["Next.js","Python", "Gemini API Key"],
  ...
  // },
  {
    ...
    name: "Resume Builder",
    description:
      "Simple Resume Builder is a user-friendly web application designed to help individuals create professional resumes quickly and easily. Built with Next.js and Tailwind CSS, it offers a clean and modern interface for users to input their personal information, work experience, education, and skills. The application provides customizable templates, allowing users to choose from various styles and formats to suit their preferences. With real-time preview functionality, users can see how their resume looks as they edit it. Once completed, the resume can be downloaded in PDF format for easy sharing and printing.",
    longDescription:
      "Simple Resume Builder is a user-friendly web application designed to help individuals create professional resumes quickly and easily. Built with Next.js and Tailwind CSS, it offers a clean and modern interface for users to input their personal information, work experience, education, and skills. The application provides customizable templates, allowing users to choose from various styles and formats to suit their preferences. With real-time preview functionality, users can see how their resume looks as they edit it. Once completed, the resume can be downloaded in PDF format for easy sharing and printing.",
    websiteUrl: "https://resume-builder-web-alpha.vercel.app/",
  images: [
