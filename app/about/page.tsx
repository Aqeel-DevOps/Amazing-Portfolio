        ...
        <div className="container px-4 sm:px-6 md:px-8 py-8 md:py-12 mx-auto max-w-4xl">
          ...
          <div className="mb-8 md:mb-12">
            ...
            <p className="text-lg md:text-xl text-[#35384a] dark:text-gray-300 leading-relaxed max-w-3xl">
              Hello! I'm Aqeel Baig, a passionate Full Stack
              ...
              started when I completed Graduation , and since then, I've been
              constantly learning and evolving with the ever-changing Techonologies 
              like With Python, Agentic-AI, OpenAI-SDk, Rag-system, Agents and  landscape
              of web technologies.
            </p>
          </div>
          ...
          <div className="mb-8 md:mb-16">
            ...
            <div className="space-y-4 md:space-y-6 text-base md:text-lg text-[#35384a] dark:text-gray-300">
              <p>
                ...
                programming started when I completed Graduation , and since then, I've been
              constantly learning and evolving with the ever-changing Techonologies 
              like With Python, Agentic-AI, OpenAI-SDk, Rag-system, Agents and  landscape
              of web technologies.
              </p>
              <p>
                ...
                Python,Crewai,Langchain, for backend services.
                also learning about AI and its applications in web development.
