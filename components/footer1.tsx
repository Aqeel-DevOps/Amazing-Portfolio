...
export function Footer1() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("nomy.hope07@gmail.com")
    setCopied(true)
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="pt-8 border-t border-border w-full max-w-md">
            ...
            <div className="flex justify-center gap-4">
              <Link href="https://github.com/aqeel-devops" target="_blank" className="p-2 rounded-full bg-muted/80 hover:bg-muted transition-colors">
                <FaGithub className="h-5 w-5" />
                <span className="sr-only">Github</span>
              </Link>
              <Link href="https://www.linkedin.com/in/aqeel-devopss/" target="_blank" className="p-2 rounded-full bg-muted/80 hover:bg-muted transition-colors">
              ...
              <Link href="https://www.facebook.com/aqeel" target="_blank" className="p-2 rounded-full bg-muted/80 hover:bg-muted transition-colors">
          ...
          <div className="text-sm text-muted-foreground text-[#35384a] dark:text-gray-200">
            ...
            <p className="mt-1">
              <Link href="#" className="underline underline-offset-2 hover:text-foreground">Aqeel Baig</Link>
            </p>
          </div>
        </div>
      </div>
